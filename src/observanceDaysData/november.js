export const november = [
    ...
    },
    {
        ...
        description: `Observed on November 6th, this day raises awareness about the environmental damage caused by warfare. It emphasizes the need for stronger 
        laws to protect natural habitats and promotes sustainable peacebuilding efforts that incorporate environmental considerations. Safeguarding our planet 
        is crucial for a healthier, conflict-free future.`,
        links:[]
    },
    {
        date: "10 November",
        day: "World Science Day for Peace and Development",
        description: `Celebrated on November 10th, this day highlights the critical role of science in society and the need for international collaboration 
        to tackle global challenges. It promotes scientific research and innovation for sustainable development, peace, and community well-being. Celebrating 
        scientists' contributions inspires future generations to pursue knowledge and positively impact the world.`,
        links:[]
    },
    {
        date: "Third Thursday of November",
        day: "Use Less Stuff Day",
        description: `A day to raise awareness about the environmental impact of our consumption and waste, and to encourage us to adopt a more minimalist 
        and sustainable lifestyle. Reduce your consumption of disposable items, such as plastic bottles, paper cups, and plastic bags. Use reusable alternatives 
        instead, such as glass bottles, ceramic mugs, and cloth bags.`,
        links:[]
    },
    {
        date: "19 November",
    ...
    },
    {
        ...
        description: `Different from World Turtle Day, World Turtle Adoption Day focuses on the adoption and care of turtles that are stranded and are in need 
        of love.  Turtles are reptiles that live in various habitats around the world, but many of them are threatened by human activities, such as hunting, 
    ...
    },
    {
        date: "29 November",
        day: "Buy Nothing Day",
        description: `Buy Nothing Day is a day of protest in which participants pledge to buy nothing for 24 hours to raise awareness of the negative environmental, 
        social, and political consequences of overconsumption. It is typically observed in North America on the Friday following Thanksgiving Day in the United States, 
        which is one of the busiest shopping days of the year.`,
        links:[]
    },
    {
        date: "29 November",
        day: "International Jaguar Day",
