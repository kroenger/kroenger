export const september = [
    ...
    },
    {
        ...
        description: `A day to celebrate and appreciate those who have chosen to live a meat-free and animal-product-free lifestyle. Being vegetarian may improve your health by 
        lowering your risk of heart disease, cancer, diabetes, and obesity. It may also help animals and the environment by reducing animal suffering, resource consumption, and 
    ...
    },
    {
        date: "September 22",
        day: " World Rhino Day",
        description: `Rhinos are amazing animals that play a vital role in maintaining the health and diversity of their habitats. You can adopt a rhino through WWF or other 
        organizations that work to protect rhinos and their habitats. By adopting a rhino, you can contribute to the funding of anti-poaching patrols, habitat restoration, 
        community engagement, and other conservation efforts.`,
        links:[]
    },
    {
        date: "Fourth Saturday of September",
        day: " International Rabbit Day",
        description: `A global observance dedicated to raising awareness about the well-being and welfare of rabbits, while also highlighting their importance as companion 
        animals and in the wild. Rabbits are prone to viral diseases and can become easy prey for a lot of animals. `,
        links:[]
    },
    {
        date: "Fourth Sunday of September",
        day: "World River Day",
        description: `Rivers are the arteries of our planet; they are lifelines in the truest sense.  World Rivers Day events include river cleanups, educational outings, 
        community festivals, art projects, and more. You can join the celebration by visiting your local river, using water wisely, choosing eco-friendly products, and 
        spreading the word about river conservation. `,
        links:[]
    },
    {
        date: "September 29",
        day: "International Day of Awareness of Food Loss and Waste",
        description: `The goal of this day is to raise awareness of the importance of food loss and waste. Food loss and waste have many negative economic and environmental 
        impacts. When food is wasted, the resources that go into producing and making food available to consumers are also wasted. Reducing food loss and waste can improve 
        food security and nutrition, lower greenhouse gas emissions and reduce pressures on natural resources such as land and water.`,
        links:[]
    },
    {
        date: "September 30",
        day: "Save the Koala Day",
        description: `Koalas are one of Australia’s most iconic and beloved animals, but they face threats from habitat loss, climate change, disease, and human activity, 
        contributing to population declines. You can do your part to prevent the unthinkable from happening by adopting a koala, planting a tree, making a donation, or 
        sharing educational resources about koalas and their habitats`,
        links:[]
    }
